...
public class MainPageObject {
  ...
  public void scrollWebPageTitleElementNotVisible(String locator, String errorMessage, int max_swipes) {
    if (Platform.getInstance().isMV()) {
  ...
  public void tryClickElementWithFewAttempts(String locator, String errorMessage, int amountOfAttemps) {
    ...
    while (need_more_attempts) {
      try {
        ...
        if (current_attempts > amountOfAttemps) {
          this.waitForElementAndClick(locator, errorMessage, 1);
        }
      }
      ++current_attempts;
